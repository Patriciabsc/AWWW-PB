...
ActiveRecord::Schema.define(version: 2018_09_17_134007) do
  ...
  add_foreign_key "travels", "countries"
  add_foreign_key "travels", "users"
  add_foreign_key "visuals", "countries"
  add_foreign_key "visuals", "travels"
