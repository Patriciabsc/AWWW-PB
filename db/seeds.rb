...
travel_1 = Travel.create!(name: 'Discover Indonesia', description: 'Grand tour of Indonesia', country_id: 1)
...
visual_1 = Visual.create!(name: 'Indonesia Visual', country_id: 1, travel_id: 1, visual_url: 'https://www.timeshighereducation.com/sites/default/files/styles/the_breaking_news_image_style/public/indonesia.jpg?itok=V1o6n7Y7')
